...
<%@page import="org.solent.com528.project.impl.web.WebClientObjectFactory"%>
...
<%
    ...
    PriceCalculatorDAO priceCalculatorDAO = WebClientObjectFactory.getPriceCalculatorDAO();
