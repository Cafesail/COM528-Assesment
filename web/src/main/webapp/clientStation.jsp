...
<%
    ...
    if ("createStation".equals(actionStr)) {
        ...
        if (stationName == null) {
            ...
            station = stationDAO.findByName(stationName);
            // this removes station from ticketMachine
            TicketMachine newTicketMachine = new TicketMachine();
           
            newTicketMachine.setStation(station);
            newTicketMachine = ticketMachineDAO.save(newTicketMachine);
...
<html>
    ...
    <body>
        ...
        <form action="./ticketMachine.jsp" method="get">
            ...
            <button type="submit" >Select ticket machine</button>
        </form> 
        <%
            }
        %>
